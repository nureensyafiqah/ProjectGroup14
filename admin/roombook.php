                ...
                <div class="row">
					...
					<?php
						...
						while($rrow=mysqli_fetch_array($rre))
						{
							...
							if($s=="Bayu Senja Suite" )
							{
								$sr = $sr + 1;
							}
							if($s=="Bayu Suria Suite" )
							{
								$dr = $dr + 1;
							}
							if($s=="Bayu Family Suite" )
							{
								$dr = $dr + 1;
							}
							if($s=="Anjung Suite" )
						...
						while($crow=mysqli_fetch_array($cre))
						{
							...
							if($cs=="Bayu Senja Suite" )
							{
								$csr = $csr + 1;
							}
							if($cs=="Bayu Suria Suite" )
							{
								$cdr = $cdr + 1;
							}
							if($cs=="Bayu Family Suite" )
							{
								$cdr = $cdr + 1;
							}
							if($cs=="Anjung Suite" )
...
<?php
						...
						{	
							...
							if($st=="Confirm")
							{
								...
								if($f1=="NO" )
								{
									echo "<script type='text/javascript'> alert('Sorry! Not Available Damai Suite ')</script>";
								}
								else if($f2 =="NO")
									{
										echo "<script type='text/javascript'> alert('Sorry! Not Available Cahaya Suite')</script>";
										
									}
									else if ($f3 == "NO")
									{
										echo "<script type='text/javascript'> alert('Sorry! Not Available Bayu Senja Suite')</script>";
									}
										else if($f4=="NO")
										{
										echo "<script type='text/javascript'> alert('Sorry! Not Available Bayu Suria Suite')</script>";
										}

										else if ($f5 == "NO")
										{
											echo "<script type='text/javascript'> alert('Sorry! Not Available Bayu Family Suite')</script>";
										}
										else if ($f6 == "NO")
										{
											echo "<script type='text/javascript'> alert('Sorry! Not Available Anjung Suite')</script>";
										}
											...
											{	
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														if($troom=="Damai Suite")
														{
															$type_of_room = 320;
														
														}
														else if($troom=="Cahaya Suite")
														{
															$type_of_room = 220;
														}
														else if($troom=="Bayu Senja Suite")
														{
															$type_of_room = 180;
														}
														else if($troom=="Bayu Suria Suite")
														{
															$type_of_room = 150;
														}
														else if($troom=="Bayu Family Suite")
														{
															$type_of_room = 150;
															
														}
														else if($troom=="Anjung Suite")
														{
															$type_of_room = 150;
														}
